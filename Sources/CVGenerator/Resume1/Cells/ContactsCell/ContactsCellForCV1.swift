...
class ContactsCellForCV1: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        mainStack.arrangedSubviews.forEach {
            $0.viewWithTag(1)?.backgroundColor = configurator.cvColors[2]
            UIViewExtensions.round(view: $0.viewWithTag(1), radius: 13)
        }
    }
    
    
    private func setDefaultsUI() {
        selectionStyle = .none
